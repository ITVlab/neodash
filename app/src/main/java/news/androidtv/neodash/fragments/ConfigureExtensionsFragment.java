package news.androidtv.neodash.fragments;
...
public class ConfigureExtensionsFragment extends Fragment implements
    ...
    private ConfigureExtensionsFragment.ExtensionListAdapter mSelectedExtensionsAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ViewGroup rootView = (ViewGroup) inflater.inflate(
                net.nurik.roman.dashclock.R.layout.fragment_configure_extensions, container, false);

        rootView.setBackgroundColor(getResources().getColor(R.color.white_50_alpha));
        ...
        mAddFabView = rootView.findViewById(net.nurik.roman.dashclock.R.id.add_extension_fab);
        ...
        mUndoBarController = new UndoBarController(rootView.findViewById(net.nurik.roman.dashclock.R.id.undobar), this);
        ...
        for (ExtensionListing listing : mExtensionManager.getAvailableExtensions()) {
            ...
            if (listing.icon() != 0) {
                Bitmap icon = Utils.loadExtensionIcon(getActivity(), extension,
                        listing.icon(), null, res.getColor(net.nurik.roman.dashclock.R.color.extension_item_color));
    ...
    private void showAddExtensionMenu(View anchorView) {
        ...
        for (int i = 0; i < mAvailableExtensions.size(); i++) {
            ...
            if (listing != null && !listing.compatible()) {
                label = getString(net.nurik.roman.dashclock.R.string.incompatible_extension_menu_template, label);
            }
        ...
        mAddExtensionPopupMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem menuItem) {
                ...
                if (extensionListing == null || !extensionListing.compatible()) {
                    ...
                    com.google.android.apps.dashclock.configuration.ConfigureExtensionsFragment.CantAddExtensionDialog
    ...
    private class ConfigurationDragSortController extends DragSortController {
        ...
        public ConfigurationDragSortController() {
            super(ConfigureExtensionsFragment.this.mListView, net.nurik.roman.dashclock.R.id.drag_handle,
    ...
    private void showRemoveUndoBar(int[] reverseSortedPositions) {
        ...
        if (reverseSortedPositions.length == 1) {
            ...
            undoString = getString(net.nurik.roman.dashclock.R.string.extension_removed_template,
                    (listing != null) ? listing.title() : "??");
        } else {
            undoString = getString(net.nurik.roman.dashclock.R.string.extensions_removed_template,
    ...
    public class ExtensionListAdapter extends BaseAdapter {
                ...
                case VIEW_TYPE_ITEM: {
                    ...
                    if (convertView == null) {
                        convertView = getActivity().getLayoutInflater()
                                .inflate(net.nurik.roman.dashclock.R.layout.list_item_extension, parent, false);
                    }
                    ...
                    View overflowButton = convertView.findViewById(net.nurik.roman.dashclock.R.id.overflow_button);
                    ...
                    if (listing == null || TextUtils.isEmpty(listing.title())) {
                        ...
                        overflowButton.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                ...
                                menu.inflate(net.nurik.roman.dashclock.R.menu.configure_item_overflow);
                                if (listing.settingsActivity() == null) {
                                    menu.getMenu().findItem(net.nurik.roman.dashclock.R.id.action_settings).setVisible(false);
                                }
                                menu.setOnMenuItemClickListener(
                                        new ConfigureExtensionsFragment.ExtensionListAdapter.OverflowItemClickListener(position));
                                menu.show();
                            }
                        });
                    }
        ...
        private class OverflowItemClickListener implements PopupMenu.OnMenuItemClickListener {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                ...
                if (item.getItemId() == net.nurik.roman.dashclock.R.id.action_remove) {
                    mSwipeDismissTouchListener.dismiss(mPosition);
                    return true;
                } else if (item.getItemId() == net.nurik.roman.dashclock.R.id.action_settings) {
    ...
    public static class CantAddExtensionDialog extends DialogFragment {
        ...
        public static com.google.android.apps.dashclock.configuration.ConfigureExtensionsFragment.CantAddExtensionDialog createInstance(String extensionPackageName,
                                                                                                                                        String extensionTitle) {
            com.google.android.apps.dashclock.configuration.ConfigureExtensionsFragment.CantAddExtensionDialog fragment = new com.google.android.apps.dashclock.configuration.ConfigureExtensionsFragment.CantAddExtensionDialog();
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            ...
            return new AlertDialog.Builder(getActivity(), net.nurik.roman.dashclock.R.style.Theme_Dialog)
                    .setTitle(net.nurik.roman.dashclock.R.string.incompatible_extension_title)
                    .setMessage(Html.fromHtml(getString(
                            net.nurik.roman.dashclock.R.string.incompatible_extension_message_search_play_template,
                            extensionTitle)))
                    .setPositiveButton(net.nurik.roman.dashclock.R.string.search_play,
                    ...
                    .setNegativeButton(net.nurik.roman.dashclock.R.string.cancel,
                            new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int whichButton) {
                                    dialog.dismiss();
                                }
