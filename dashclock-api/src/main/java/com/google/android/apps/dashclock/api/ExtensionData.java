...
public class ExtensionData implements Parcelable {
     ...
     * using {@link android.content.ContentResolver#openFileDescriptor(Uri, String)} and
     ...
     * {@link android.content.Context#startActivity(Intent)}) when the user clicks
